...
async function show_popup(card) {
    ...
    popup_container.style.background = `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${image_path + movie.poster_path})`
            ...
            <div class="content">
                ...
                <div class="right">
                    ...
                    <div class="single-info-container">
                        ...
                        <div class="single-info">
                            <span>Budget:</span>
                            <span> ${Math.floor((movie.budget * 93) / 10000000)} Cr</span>
                        </div>
                        <div class="single-info">
                            <span>Collection:</span>
                            <span> ${Math.floor((movie.revenue * 93) / 10000000)} Cr</span>
                        </div>
                        <div class="single-info">
                            <span>Profit:</span>
                            <span> ${Math.floor(((movie.revenue - movie.budget) * 93) / 10000000)} Cr</span>
                        </div>
                        <div class="single-info">
                            <span>Release Date:</span>
...
<iframe
  width="560"
  height="615"
  src="https://www.youtube.com/embed/${movie_trailer}?autoplay=1&mute=1"
